#!/usr/bin/env python3
"""
Create Happy Horse dynamic page JSON files and register them in `localeMessagesPaths`.
...
Example:
  python .claude/skills/Happy Horse-page-builder/scripts/create_dynamic_page.py \
...
def _repo_root_from_this_file() -> Path:
    # .../.claude/skills/Happy Horse-page-builder/scripts/create_dynamic_page.py
    # parents[0]=scripts, [1]=Happy Horse-page-builder, [2]=skills, [3]=.claude, [4]=repo root
