#!/usr/bin/env python3
"""
Generate `public/logo.png` and `public/favicon.ico` for Happy Horse Quick Start.
...
def _repo_root_from_this_file() -> Path:
    # .../.claude/skills/Happy Horse-quick-start/scripts/generate-logo.py
    # parents[0]=scripts, [1]=Happy Horse-quick-start, [2]=skills, [3]=.claude, [4]=repo root
