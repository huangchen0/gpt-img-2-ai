---
name: Happy Horse-quick-start-cloudflare
description: Automate first-pass customization of a new Happy Horse seedance2 (AI Image Generator) project on Cloudflare from a short project brief. Use when the user says they are starting a new AI image generation project on Cloudflare.
---

# Happy Horse Quick Start (Project Bootstrap)
...
## Execution order (Happy Horse Two)
