...
- macOS/Linux:
  - `python3 ".claude/skills/Happy Horse-quick-start/scripts/generate-logo.py" --brand-name "<brandName>" --primary-color "<#RRGGBB>" --public-dir "public"`
- Windows (PowerShell / cmd):
  - `py ".claude\\skills\\Happy Horse-quick-start\\scripts\\generate-logo.py" --brand-name "<brandName>" --primary-color "<#RRGGBB>" --public-dir "public"`
...
- **No template imagery**: do not keep or copy any Happy Horse/logo defaults
