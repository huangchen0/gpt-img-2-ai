...
export const user = table(
  'user',
  {
    ...
    // Track first-touch referrer domain (e.g. google.com, bing.com)
    referrerDomain: text('referrer_domain').notNull().default(''),
    signupSite: text('signup_site').notNull().default(''),
    firstSeenSite: text('first_seen_site').notNull().default(''),
    lastSeenSite: text('last_seen_site').notNull().default(''),
...
export const trackingEvent = table(
  'tracking_event',
  {
    id: text('id').primaryKey(),
  ...
  (table) => [
    index('idx_tracking_event_site_created_at').on(table.site, table.createdAt),
    index('idx_tracking_event_name_created_at').on(
      table.eventName,
      table.createdAt
    ),
    index('idx_tracking_event_user_created_at').on(
      table.userId,
      table.createdAt
    ),
  ]
...
export const siteActivityDaily = table(
  'site_activity_daily',
  {
    id: text('id').primaryKey(),
  ...
  (table) => [
    uniqueIndex('uq_site_activity_daily_site_date_visitor').on(
      table.site,
      table.activityDate,
      table.visitorId
    ),
    index('idx_site_activity_daily_site_date').on(
      table.site,
      table.activityDate
    ),
    index('idx_site_activity_daily_user_date').on(
      table.userId,
      table.activityDate
    ),
  ]
