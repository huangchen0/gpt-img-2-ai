...
import { clearPendingSocialAuth } from '@/shared/lib/gtm';
  ...
  return (
    <Card className="mx-auto w-full md:max-w-md">
      <CardHeader className="justify-items-center text-center">
        ...
        <p className="rounded-full border border-amber-500/20 bg-amber-500/10 px-3 py-1 text-xs font-medium text-amber-700 dark:border-amber-400/15 dark:bg-amber-400/10 dark:text-amber-300">
          {t('sign_in_reward_hint')}
        </p>
      </CardHeader>
      <CardContent>
        <div className="grid gap-4">
          ...
          {hasSocialProviders && isEmailAuthEnabled && (
            <div className="relative flex items-center justify-center py-1 text-xs text-neutral-500">
              <div className="border-border absolute inset-x-0 border-t" />
              <span className="bg-card relative px-3">{t('or')}</span>
            </div>
          )}
